          ...
          <div class="widget widget-padding span12">
            <div class="widget-header">
              ...
              <div class="widget-buttons">
                  ...
                  <span data-title="新增一级分类" class="tip" target="_blank" id="add"><i class="icon-external-link"></i>添加</span>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="${pageContext.request.contextPath }/adminCategory_edit.action?cid=<s:property value="#c.cid"/>"><i class="icon-edit"></i> 修改</a></li>
                          <li><a href="${pageContext.request.contextPath }/adminCategory_delete.action?cid=<s:property value="#c.cid"/>"><i class="icon-trash"></i> 删除</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
    ...
    $(function() {
        $("#add").on("click", function() {
            ...
            parent.layer.open({
                ...
                fixed : false, //不固定
                //maxmin: true,
                content : '${pageContext.request.contextPath }/admin/category/add.jsp'
            });
        });
    });
