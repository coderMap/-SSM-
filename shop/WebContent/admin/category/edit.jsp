		...
		<div class="row-fluid">
          <div class="widget widget-padding span12">
            ...
            <div class="widget-body">
              <div class="formbody">
		<div class="formtitle"><span>编辑一级分类</span></div>
			<form action="${pageContext.request.contextPath }/adminCategory_update.action" method="post" id="categoryForm">
				<input type="hidden" name="cid" value="<s:property value="model.cid"/>" />
				<ul class="forminfo">
					<li><label>分类名称</label><input name="cname" id="cname" type="text" value="<s:property value="model.cname"/>" class="dfinput" maxlength="10" autofocus="autofocus" /><i id="error">分类名称不能超过10个字符</i></li> 
					<li><label>&nbsp;</label><input type="submit" class="btn" value="确认修改" style="background-color: #119619" /></li>
				</ul>
			</form>
	    </div>
            </div> <!-- /widget-body -->
