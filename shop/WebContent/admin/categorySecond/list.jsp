          ...
          <div class="widget widget-padding span12">
            <div class="widget-header">
              ...
              <div class="widget-buttons">
                  ...
                  <span data-title="新增二级分类" class="tip" target="_blank" id="add"><i class="icon-external-link"></i>添加</span>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="${pageContext.request.contextPath }/adminCategorySecond_edit.action?csid=<s:property value="#cs.csid"/>"><i class="icon-edit"></i> 修改</a></li>
                          <li><a href="${pageContext.request.contextPath }/adminCategorySecond_delete.action?csid=<s:property value="#cs.csid"/>"><i class="icon-trash"></i> 删除</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
    ...
    $(function() {
        $("#add").on("click", function() {
            ...
            parent.layer.open({
                ...
                fixed : false, //不固定
                //maxmin: true,
                content : '${pageContext.request.contextPath }/adminCategorySecond_addPage.action'
            });
        });
    }); 
</script>
